...
var x{1..I,1..J} >=0 <=1; 	#1 if client i assigned to mid level facility j, 0 otherwise
var y{1..J,1..K} >=0 <=1; 	#1 if mid level facility j is assigned to high level facility k, 0 otherwise
var z{1..J} >=0 <=1; 		#1 if mid level facility j is open, 0 otherwise
var w{1..K} >=0 <=1; 		#1 if high level facility k is open, 0 otherwise
