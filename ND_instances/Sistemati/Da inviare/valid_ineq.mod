...
param a{N, 1..S} default 0; # 1 if i in S
param b{K, 1..S} default 0; # 1 if k with source in S and destination not (not viceversa)
param c{A, 1..S} default 0; # 1 if arc ij has an extreme in S and the other not (not viceversa)
